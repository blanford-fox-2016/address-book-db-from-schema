...
var CREATE_TABLE_KONTAK_GROUP ="CREATE TABLE IF NOT EXISTS kontak_group (id INTEGER PRIMARY KEY AUTOINCREMENT, kontak_id INTEGER, group_id INTEGER, FOREIGN KEY(group_id) REFERENCES 'group'(id), FOREIGN KEY(kontak_id) REFERENCES kontak(id));"
